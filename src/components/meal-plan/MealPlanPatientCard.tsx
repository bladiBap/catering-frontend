...
import { BloodTypeChip } from '@/components/patient/BloodTypeChip'
import { Patient } from '@/models/patient/patients/Patient'

interface MealPlanPatientCardProps {
    patient: Patient
}

export function MealPlanPatientCard({ patient }: MealPlanPatientCardProps) {
    return (
        <Link
            href={`/meal-plan/${patient.patientId}`}
